...
class PCController(Controller):
    def __init__(self, render: Render, speed: float = 0.01, accute: float = 1.0, 
                 max_delta: int = 50, INVERSE_Y_AXIS=False, jump_speed: float | None = None) -> None:
            ...
            if event.type == pygame.KEYDOWN:
                ...
                #     self.key_down['space'] = False
                    ...
                    if self.show_path:
                        ...
                        self.show_path = True
                        viewer.show_path(self.camera.position)
